...
import com.kang.administrator.zhisuntestapplication.camera.open.OpenCamera
import com.kang.administrator.zhisuntestapplication.camera.open.OpenCameraInterface
...
class CameraManager(private val context: Context) {
    ...
    @Synchronized
    fun startPreview() {
        Log.i("kang","startPreview()")
        val theCamera = camera
        if (theCamera != null && !previewing) {
            Log.i("kang","theCamera != null && !previewing")
    ...
    fun getFramingRectInPreview(): Rect? {
        if (framingRectInPreview == null) {
            ...
            val screenResolution = configManager.cameraResolution
